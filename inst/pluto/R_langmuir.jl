...
md"""
With assuming $R_A \ll R$ we can simplify:
```math
\begin{aligned}
...
begin
	Q_max_input = @bind Q_max Slider(5001:100:8_000,default=7_000)
	K_eqR_input = @bind K_eqR_log Slider(-5:1,default=-3)
	md"""
	 `Q_max`: $Q_max_input, `K_eqR`: $K_eqR_input
	"""
end

# ╔═╡ 519b461c-bc99-40f1-a199-3ca766a2b61e
(Q_max, K_eqR_log)
